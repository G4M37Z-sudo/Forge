    ...
    <div className="min-h-screen py-10 px-4 sm:px-6 max-w-4xl mx-auto">
      <ScrollReveal>
          <h1 className="text-2xl sm:text-3xl font-bold text-text-primary tracking-tight mb-2" style={{ fontFamily: "'Satoshi', system-ui, sans-serif" }}>
            Join the <span className="purple-text">Forge</span> community
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-10">
          <ScrollReveal>
            <div className="glass-card p-5">
              ...
              <p className="text-xs text-text-tertiary leading-relaxed">Add new tools or improve existing ones. Each tool is a self-contained module — easy to add, test, and ship.</p>
            </div>
          </ScrollReveal>
          <ScrollReveal delay={60}>
            <div className="glass-card p-5">
              ...
              <p className="text-xs text-text-tertiary leading-relaxed">Found an edge case? Tool returning wrong output? Open an issue with the input and expected result.</p>
            </div>
          </ScrollReveal>
          <ScrollReveal delay={120}>
            <div className="glass-card p-5">
              ...
              <p className="text-xs text-text-tertiary leading-relaxed">Have an idea for a tool or workflow? Open a discussion. The best ideas come from the community.</p>
            </div>
          </ScrollReveal>
        </div>
        ...
        {/* CTA */}
        <ScrollReveal>
          <div className="glass-card p-6 text-center inner-glow-purple">
            ...
            <p className="text-sm text-text-secondary mb-4">Fork the repo, pick an issue, and open a PR. We review within 24 hours.</p>
            <Link href="/docs" className="btn-primary text-xs py-2 px-4">
